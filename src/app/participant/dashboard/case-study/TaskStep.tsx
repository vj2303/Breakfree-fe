...
const TaskStep: React.FC<TaskStepProps> = ({ activityData, submissionData, setSubmissionData }) => {
  ...
  const MEDIA_EXTENSIONS = /\.(mp4|mov|m4v|avi|wmv|flv|mkv|webm|mpe?g|3gp|mp3|m4a|aac|wav|ogg|oga|opus|flac|weba)$/i;
  const isMediaFile = (file: File) =>
    file.type.startsWith('video/') || file.type.startsWith('audio/') || MEDIA_EXTENSIONS.test(file.name);
      ...
      <div className="bg-white p-4 rounded border border-gray-200 text-gray-800">
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          {(submissionData.submissionType === 'DOCUMENT' || submissionData.submissionType === 'VIDEO') && (
            <div className="mb-3">
              <label className="block text-xs font-medium text-gray-700 mb-1.5">
                Upload {submissionData.submissionType === 'VIDEO' ? 'Video or Audio' : 'Document'}
              </label>
